<template>
	<div>
		<p class="spanTab">业务部 > 计划申报 > <span>发布公告</span></p>
		<div class="personHead" style="box-shadow: none;margin-bottom: 20px;">
			<span class="ge-head"><label>标题</label><el-input style="width:150px" v-model="listQuery.orderNumber"  size="small" placeholder="请输入标题关键词" clearable></el-input></span>
			<span class="ge-head">
				<label>阅读状态</label>
			...
			<span class="btn-b" style="position: absolute;right: 30px;height: 36px;line-height: 22px;top:15px;" >+发布公告</span>
		</div>
		<!-- <div class="person"> -->
			...
			<div class="blueTable" style="width: 98.5%;border-radius: 5px;">
				<el-table :data="tableData" :header-cell-style="{background:'#00BF6F',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
				    ...
				    <el-table-column  align="center" prop="orderNumber" label="公告标题"></el-table-column>
				    <el-table-column  align="center" prop="waybill" label="发布人员"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="公告类别"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="接收人员"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="阅读状态"></el-table-column>
