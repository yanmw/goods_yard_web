			...
			<div class="loginBody">
				<div class="loginLeft">
					<div class="loginInfo">
						...
						<!-- <p class="loginTitle" v-else><span class="userLogin">管理员登录</span> <span class="adminLogin" @click="user">用户登录</span></p> -->
						<div class="inputdiv">
