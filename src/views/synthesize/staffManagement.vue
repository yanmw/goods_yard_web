<template>
	<div>
		...
		<div class="personHead" style="box-shadow: none;margin-bottom: 20px;">
			<span class="ge-head"><label>类型</label><el-input style="width:150px" v-model="listQuery.orderNumber"  size="small" placeholder="请输入标题关键词" clearable></el-input></span>
			<span class="ge-head">
				<label>选择部门</label>
			...
			<span class="btn-b" style="position: absolute;right: 130px;height: 36px;line-height: 22px;top:15px;" >+新增员工</span>
			<span class="export" style="position: absolute;right: 30px;height: 36px;line-height: 22px;top:15px;">导出表格</span>
		</div>
		<!-- <div class="person"> -->
			...
			<div class="blueTable" style="width: 98.5%;border-radius: 5px;">
				<el-table :data="tableData" :header-cell-style="{background:'#00BF6F',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
				    ...
				    <el-table-column  align="center" prop="orderNumber" label="姓名"></el-table-column>
				    <el-table-column  align="center" prop="waybill" label="性别"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="部门"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="角色"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="手机号"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="账号状态"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="在线状态"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="最后登录时间 "></el-table-column>
				    <el-table-column align="center" label="操作" width="160">
				    	<template slot-scope="scope">
				    		<div class="tableB" >
				    			<span class="tableBtn green" @click="edit(scope.row)">设置</span>
