<template>
	<div>
		<p class="spanTab">业务部 > 公司管理 > <span>组织架构</span></p>
		<div class="personHead" style="box-shadow: none;margin-bottom: 20px;">
			...
			<span class="btn-b" style="position: absolute;right: 30px;height: 36px;line-height: 22px;top:15px;" >+新增部门</span>
		</div>
		<!-- <div class="person"> -->
			...
			<div class="blueTable" style="width: 98.5%;border-radius: 5px;">
				<el-table :data="tableData" :header-cell-style="{background:'#00BF6F',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
				    ...
				    <el-table-column  align="center" prop="orderNumber" label="部门名称"></el-table-column>
				    <el-table-column  align="center" prop="waybill" label="成员数量"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="负责人"></el-table-column>
				    <el-table-column  align="center" prop="createDate" label="部门描述"></el-table-column>
				    <el-table-column  align="center" prop="purchaser" label="更新时间"></el-table-column>
