<template>
	<div>
		<p class="spanTab">综合部 > 公司管理 > <span>岗位权限</span></p>
		...
		<!-- <div class="personHead" style="box-shadow: none;margin-bottom: 20px;">
			<span class="ge-head"><label>岗位名称</label><el-input style="width:150px" v-model="listQuery.columnFilters.name.value"  size="small" placeholder="请输入岗位名称" clearable></el-input></span>
			<span class="btn-b" @click="handleFilter">查询</span>
			<span class="btn-ba" @click="reset">重置</span>
			<span class="btn-b" style="position: absolute;right: 30px;height: 36px;line-height: 22px;top:15px;" @click="add('ruleForm')">+新增岗位</span>
		</div> -->
		<!-- <div class="person"> -->
			...
			<!-- <div class="blueTable" style="width: 98.5%;border-radius: 5px;">
				<el-table :data="tableData" :header-cell-style="{background:'#00BF6F',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
				    ...
				    <el-table-column  align="center" prop="title" label="岗位名称"></el-table-column>
				    ...
				    <el-table-column align="center" label="操作"  width="160px">
				    	<template slot-scope="scope">
				    		<div class="tableB" >
				    			<span class="tableBtn blue" @click="add(scope.row)">编辑</span>
		...
		<!-- 	<el-dialog title="新增部门" :visible.sync="dialogVisible" :close-on-click-modal="false">
			...
			<el-dialog title="新增岗位" :visible.sync="centerDialogVisible"  width="50%" center :close-on-click-modal="false">
			  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="width: 60%;margin: 0 auto;">
			    <el-form-item label=" 岗位名称:" prop="title">
			      <el-input v-model="ruleForm.title" maxlength="20" placeholder="请输入岗位名称"></el-input>
			    </el-form-item>
			    <el-form-item label="备注:" prop="content">
			      <el-input type="textarea" v-model="ruleForm.content" resize="none" maxlength="200" placeholder="请输入部门"></el-input>
			    </el-form-item>
			    <!-- <el-form-item>
