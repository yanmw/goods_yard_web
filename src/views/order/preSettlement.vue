<template>
	<div class="person">
		...
		<p class="personTit">订单管理>预结算订单 <span class="export"  @click="handleDownload">导出表格</span></p>
		<div class="blueTable" style="width: 98.5%;border: 1px solid #256ff8;border-radius: 5px;">
			<el-table :data="tableData" :header-cell-style="{background:'#256ff8',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
			    ...
			    <el-table-column  align="center" prop="createDate" label="交易时间" width="170px"></el-table-column>
			    ...
			    <el-table-column  align="center" prop="ton" label="订单吨数(吨)" width="110px"></el-table-column>
