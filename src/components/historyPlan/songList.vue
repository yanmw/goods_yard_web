		...
		<div class="personHead" style="box-shadow: none;margin-bottom: 20px;">
		   	...
		   	<div class="blueTable" style="width: 98.5%;border-radius: 5px;">
		   		<el-table :data="tableData1" :header-cell-style="{background:'#00BF6F',color:'#fff',borderRight:'none'}" stripe v-loading="loading"  style="width: 100%;border-radius: 5px;" align="center" border>
		   		    ...
		   		    <el-table-column  align="center" prop="totalCar" label="送车总数" ></el-table-column>
		   		    <el-table-column  align="center" prop="cargo" label="装车货品"></el-table-column>
		   		    <el-table-column  align="center" prop="containerCargo" label="亏吨">
						<template slot-scope="scope">
							<span>{{scope.row.loseCar}}车</span>
						</template>
					</el-table-column>
					<el-table-column  align="center" prop="containerCargo" label="超吨" >
						<template slot-scope="scope">
							<span>{{scope.row.overCar}}车</span>
						</template>
					</el-table-column>
					<el-table-column  align="center" prop="containerCargo" label="坏车数">
						<template slot-scope="scope">
							<span>{{scope.row.badCar}}车</span>
						</template>
					</el-table-column>
					<el-table-column  align="center" prop="actualCar" label="需装车数"></el-table-column>
		   		    <el-table-column  align="center" prop="pullPushTime" label="送车时间" width="160"></el-table-column>
